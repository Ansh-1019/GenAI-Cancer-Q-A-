...
# 1. Input File Paths (Moved to consolidated data directory)
PUBMED_FILE = "./data/raw_json/pubmed_cancer_abstracts.json"
EMA_FILE = "./data/raw_json/non_epar-documents_json_20251121t060507z.json"
...
def load_data_from_json(file_path: str, content_key: str, encoding: str = 'utf-8') -> List[Document]:
    ...
    # Assume data is a list of dictionaries at the root level
...
if __name__ == "__main__":
    ...
    # Step 2: Load EMA Data (Use 'name' key and the fallback encoding)
